        ...
        stage ('Build, Test and Publish Jobs to Nexus') {
                    withMaven(
                           ...
                           // mavenSettingsConfig: 'maven-file',
                            mavenOpts: '-Dupdatesite.path=http://13.233.125.1:8082/P2/ -Dlicense.path=/opt/remote.license -Dgeneration.type=local  -DaltDeploymentRepository=id::default::http://admin:admin123@13.232.174.181:8081/repository/thirdparty/ -Xms1024m -Xmx3096m') 
                            {
